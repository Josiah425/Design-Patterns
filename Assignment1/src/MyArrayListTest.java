...
public class MyArrayListTest {
	...
	public void testMe(MyArrayList myArrayList, Results results){
		...
		if(sizeDecrement(myArrayList)) results.storeNewResults("test sizeDecrement passed");
		else results.storeNewResults("test sizeDecrement failed, incorrect size returned");
	 ...
	 * @return (boolean)
	 */
	public boolean sizeDecrement(MyArrayList myArrayList){
		for(int i = 0; i <= 10000; i++){
			myArrayList.removeValue(i);
			if(i < 20) myArrayList.insertSorted(i);
		}
	...
	/**
	 * Check if inserting duplicate values works
	 * 
	 * @param (MyArrayList) myArrayList
	 * @return (boolean)
	 */
